...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light sticky-top">
    <div class="container">
      <a href="{{ url('/') }}" class="navbar-brand">
        <img src="{{ asset('img/7Sheep.png') }}" alt="AdminLTE Logo" class="brand-image">
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <li class="nav-item">
            <form action="{{ url('logout') }}" method="POST" class="form-inline" id="logout">
                @csrf
            </form>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> 7Sheep <small>v1.0</small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
        Made with <span class="text-pink"><i class="fa fa-heart"></i></span> by Arief Afrilian
    </div>
    <!-- Default to the left -->
